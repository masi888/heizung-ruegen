...
export function TrustBar() {
  return (
    <div className="bg-surface-container-low border-y border-outline-variant/15">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-6 flex flex-wrap justify-center lg:justify-between gap-x-6 gap-y-4 text-sm font-semibold text-primary/80">
        {textItems.map((item) => (
